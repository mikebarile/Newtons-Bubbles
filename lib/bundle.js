...
/***/ function(module, exports, __webpack_require__) {
	...
	class Game {
	  ...
	  allBubbles() {
	    let newArray = this.userBubbles.concat(this.bubbles).concat(this.glitter);
	    return newArray;
	  }
...
/***/ function(module, exports, __webpack_require__) {
	...
	class MovingObject {
	  ...
	  move(delta) {
	    ...
	    if (this.glitter && this.radius >= 0.03) {
	      this.radius = this.radius - 0.03;
	    }
